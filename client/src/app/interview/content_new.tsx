                ...
                <header className="min-h-[64px] border-b border-white/5 bg-black/40 backdrop-blur-2xl px-8 flex items-center justify-between shrink-0 relative z-50">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-4">
                            <div className={`flex px-4 py-2 rounded-full border items-center gap-3 text-[9px] font-black tracking-[0.2em] transition-all duration-700 ${isMentorWatching ? 'border-amber-500/30 bg-amber-500/10 text-amber-400' : 'border-white/10 bg-white/5 text-zinc-400'}`}>
                                <div className={`w-1.5 h-1.5 rounded-full ${isMentorWatching ? 'bg-amber-400' : 'bg-emerald-400'}`} />
